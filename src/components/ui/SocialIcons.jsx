...
export function SocialIcons() {
  ...
  return (
    <div className="social-icons-wrapper">
      <div className="social-icons-gradient" />
      ...
      {socials.map((social, index) => (
        ...
        >
          <span
            className={`social-icon-hover-bg ${
              hoveredIndex === index ? "opacity-100 scale-100" : "opacity-0 scale-90"
            }`}
          />

          <span
            className={`social-icon-svg-container ${
              hoveredIndex === index ? "text-white scale-110" : ""
            }`}
          >
            {social.icon}
          </span>
          ...
          <span
            className={`social-icon-indicator ${
          ...
          >
            {social.name}
            <span className="social-icon-tooltip-arrow" />
          </span>
        </a>
      ))}
    </div>
